...
budget = int_check("What is your budget (Minimum $12, Maximum $200)?\n", 12, 200)
...
while budget > 11.99:
    ...
    max = budget / selected_item['price']
    max_amt = str(max)[0]
    ...
    while selected_items > 0:
        ...
        selected_item['stock'] = selected_item['stock']-1
...
print("You my man, have run out of funds\n")
